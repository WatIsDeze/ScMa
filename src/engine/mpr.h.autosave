...
namespace mpr
{
    ...
    struct Ent
    {
        ...
        Ent(entities::classes::BaseEntity *ent) : ent(ent) {}
    ...
    struct EntOBB : Ent
    {
        ...
        EntOBB(entities::classes::BaseEntity *ent) : Ent(ent)
        {
    ...
    struct EntFuzzy : Ent
    {
        EntFuzzy(entities::classes::BaseEntity *ent) : Ent(ent) {}
    ...
    {
        EntCylinder(entities::classes::BaseEntity *ent) : EntFuzzy(ent) {}
    ...
    {
        EntCapsule(entities::classes::BaseEntity *ent) : EntFuzzy(ent) {}
    ...
    {
        EntEllipsoid(entities::classes::BaseEntity *ent) : EntFuzzy(ent) {}
