...
struct skelmodel : animmodel
{
    ...
    struct skelmeshgroup : meshgroup
    {
        ...
        void intersect(const animstate *as, float pitch, const vec &axis, const vec &forward, entities::classes::BaseEntity *d, part *p, const vec &o, const vec &ray)
        {
            if(!hitdata) return;
        ...
        void render(const animstate *as, float pitch, const vec &axis, const vec &forward, entities::classes::BaseEntity *d, part *p)
        {
