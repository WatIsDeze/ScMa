...
IF(CMAKE_SIZEOF_VOID_P EQUAL 8)
  set(SDL2LIB_PATH_SUFFIX lib64 lib/x64)
# On 32bit build find the 32bit libs
ELSE(CMAKE_SIZEOF_VOID_P EQUAL 8)
  set(SDL2LIB_PATH_SUFFIX lib lib/x86)
...
FIND_LIBRARY(SDL2_LIBRARIES_TEMP
	...
	HINTS
	$ENV{SDL2DIR}
	# HACK: search SDL2 also in lib even for 64-bit?
	PATH_SUFFIXES ${SDL2LIB_PATH_SUFFIX} lib
	PATHS ${SDL2_SEARCH_PATHS}
)
...
IF(NOT SDL2_BUILDING_LIBRARY)
	IF(NOT ${SDL2_INCLUDE_DIRS} MATCHES ".framework")
		...
		FIND_LIBRARY(SDL2MAIN_LIBRARY
			...
			HINTS
			$ENV{SDL2DIR}
			PATH_SUFFIXES ${SDL2LIB_PATH_SUFFIX}
			PATHS ${SDL2_SEARCH_PATHS}
		)
		IF(SDL2MAIN_LIBRARY)
